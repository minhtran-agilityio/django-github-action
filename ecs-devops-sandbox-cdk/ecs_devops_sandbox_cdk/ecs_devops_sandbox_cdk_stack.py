...
class EcsDevopsSandboxCdkStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        ecr_repository = ecr.Repository(
            ...
            repository_name="962372302662-ecs-devops-sandbox-repository"
        )
        ...
        # Create the ECS Task Definition with placeholder container
        # (and named Task Execution IAM Role)
        ...
        # Create role for authen with ECR, create and put logs
